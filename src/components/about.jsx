        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>I am a developer who loves exploring new technologies and trying new things (obviously!)</p>
                       <p>My background is in social sciences from where I decided to start coding in 2018</p>
                    </div>
                </div>
                </div>
            </div>
